...
const (
	...
	ProtocolsBGPNeighborVPNIPv4Advertised Path = "protocols.bgp.neighbors.<*:ip>.vpn.ipv4.advertised-routes"
	ProtocolsBGPNeighborVPNIPv4Received   Path = "protocols.bgp.neighbors.<*:ip>.vpn.ipv4.received-routes"
	ProtocolsBGPNeighborVPNIPv4Routes     Path = "protocols.bgp.neighbors.<*:ip>.vpn.ipv4.routes"
	ProtocolsBGPNeighborVPNIPv6Advertised Path = "protocols.bgp.neighbors.<*:ip>.vpn.ipv6.advertised-routes"
	ProtocolsBGPNeighborVPNIPv6Received   Path = "protocols.bgp.neighbors.<*:ip>.vpn.ipv6.received-routes"
	ProtocolsBGPNeighborVPNIPv6Routes     Path = "protocols.bgp.neighbors.<*:ip>.vpn.ipv6.routes"
	...
	ProtocolsBGPVPNIPv4SummaryAll    Path = "protocols.bgp.vpn.ipv4.summary.all"
	ProtocolsBGPVPNIPv6SummaryAll    Path = "protocols.bgp.vpn.ipv6.summary.all"
	ProtocolsBGPVPNIPv4Statistics    Path = "protocols.bgp.vpn.ipv4.statistics"
	ProtocolsBGPVPNIPv6Statistics    Path = "protocols.bgp.vpn.ipv6.statistics"
	ProtocolsBGPVPNIPv4StatisticsAll Path = "protocols.bgp.vpn.ipv4.statistics.all"
	ProtocolsBGPVPNIPv6StatisticsAll Path = "protocols.bgp.vpn.ipv6.statistics.all"
	ProtocolsBGPVPNIPv4RD            Path = "protocols.bgp.vpn.ipv4.rd.<*:rd>"
	ProtocolsBGPVPNIPv6RD            Path = "protocols.bgp.vpn.ipv6.rd.<*:rd>"
	ProtocolsBGPVPNIPv4Prefix        Path = "protocols.bgp.vpn.ipv4.prefix.<*:prefix>"
	ProtocolsBGPVPNIPv6Prefix        Path = "protocols.bgp.vpn.ipv6.prefix.<*:prefix>"
	...
	SystemRecoveryStatus             Path = "system.recovery.status"
	...
	ProtocolsFIBIPv4                  Path = "protocols.fib.ipv4"
	ProtocolsFIBIPv4Table             Path = "protocols.fib.ipv4.<*:uint32>"
	ProtocolsFIBIPv4Prefix            Path = "protocols.fib.ipv4.<*:uint32>.<*:prefix>"
	ProtocolsFIBIPv4Summary           Path = "protocols.fib.ipv4.summary"
	ProtocolsFIBIPv6                  Path = "protocols.fib.ipv6"
	ProtocolsFIBIPv6Table             Path = "protocols.fib.ipv6.<*:uint32>"
	ProtocolsFIBIPv6Prefix            Path = "protocols.fib.ipv6.<*:uint32>.<*:prefix>"
	ProtocolsFIBIPv6Summary           Path = "protocols.fib.ipv6.summary"
	...
	ProtocolsLDPCapabilities          Path = "protocols.ldp.capabilities"
	ProtocolsLDPIGPSync               Path = "protocols.ldp.igp-sync"
	ProtocolsLDPInterface             Path = "protocols.ldp.interface"
	ProtocolsLDPNeighbor              Path = "protocols.ldp.neighbors.<*:ip>"
	ProtocolsLDPNeighborDetail        Path = "protocols.ldp.neighbors.<*:ip>.detail"
	ProtocolsLDPNeighborCapabilities  Path = "protocols.ldp.neighbors.<*:ip>.capabilities"
	ProtocolsLDPNeighborsCapabilities Path = "protocols.ldp.neighbors.capabilities"
	ProtocolsLDPBindingPrefix         Path = "protocols.ldp.bindings.<*:prefix>"
